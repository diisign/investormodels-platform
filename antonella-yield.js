// Calcul du Dernier Yield distribué pour Antonella ❤
...
// Antonella ❤ a l'ID creator5
const antonellaId = "creator5";
const antonellaYieldData = generateYieldData(antonellaId);
const antonellaLastYield = antonellaYieldData[antonellaYieldData.length - 1];

console.log(`❤ Antonella ❤ - Dernier Yield distribué: ${antonellaLastYield.value.toFixed(2)}% APY`);