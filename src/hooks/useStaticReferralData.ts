...
const STATIC_REFERRALS: StaticReferral[] = [
  // Juin 2025 - 5800€ total (triés du plus récent au plus ancien)
  { name: 'SkyllaGaming', date: '30/06/2025', status: 'completed', reward: 100 },
  { name: 'MoonPhoenix', date: '30/06/2025', status: 'completed', reward: 50 },
  { name: 'CyberWolfX', date: '29/06/2025', status: 'completed', reward: 100 },
  { name: 'NeonDreamer', date: '29/06/2025', status: 'pending', reward: 75 },
  { name: 'PixelHunter', date: '28/06/2025', status: 'completed', reward: 100 },
  { name: 'StardustRider', date: '28/06/2025', status: 'completed', reward: 50 },
  { name: 'VoidSeeker', date: '27/06/2025', status: 'pending', reward: 75 },
  { name: 'ThunderStrike', date: '27/06/2025', status: 'completed', reward: 100 },
  { name: 'CrimsonLord', date: '26/06/2025', status: 'completed', reward: 50 },
  { name: 'BlazeFury', date: '26/06/2025', status: 'completed', reward: 75 },
  { name: 'IceCold', date: '25/06/2025', status: 'completed', reward: 100 },
  { name: 'FireStorm', date: '25/06/2025', status: 'completed', reward: 50 },
  { name: 'WindSlash', date: '24/06/2025', status: 'completed', reward: 75 },
  { name: 'EarthShaker2', date: '24/06/2025', status: 'completed', reward: 100 },
  { name: 'UniverseKing', date: '22/06/2025', status: 'completed', reward: 100 },
  { name: 'GalacticLord', date: '23/06/2025', status: 'completed', reward: 50 },
  { name: 'PlanetHunter', date: '21/06/2025', status: 'completed', reward: 75 },
  { name: 'StarCrusher', date: '20/06/2025', status: 'completed', reward: 100 },
  { name: 'InterGalaxy', date: '19/06/2025', status: 'completed', reward: 50 },
  { name: 'AstralDragon', date: '18/06/2025', status: 'completed', reward: 75 },
  { name: 'StellarHawk', date: '17/06/2025', status: 'completed', reward: 100 },
  { name: 'LunarWolf', date: '16/06/2025', status: 'completed', reward: 50 },
  { name: 'SolarKnight', date: '15/06/2025', status: 'completed', reward: 75 },
  { name: 'CosmicWarrior', date: '14/06/2025', status: 'completed', reward: 100 },
  { name: 'NebulaFighter', date: '13/06/2025', status: 'completed', reward: 50 },
  { name: 'GalaxyGuard', date: '12/06/2025', status: 'completed', reward: 75 },
  { name: 'StarWarrior', date: '11/06/2025', status: 'completed', reward: 100 },
  { name: 'SpaceRider', date: '10/06/2025', status: 'completed', reward: 50 },
  { name: 'TimeKeeper', date: '09/06/2025', status: 'completed', reward: 75 },
  { name: 'VoidWalker', date: '08/06/2025', status: 'completed', reward: 100 },
  { name: 'LightBearer2', date: '07/06/2025', status: 'completed', reward: 50 },
  { name: 'ShadowBane', date: '06/06/2025', status: 'completed', reward: 75 },
  { name: 'FrostGuard', date: '05/06/2025', status: 'completed', reward: 100 },
  { name: 'FlameWarden', date: '04/06/2025', status: 'completed', reward: 50 },
  { name: 'StormBreaker', date: '03/06/2025', status: 'completed', reward: 75 },
  { name: 'DarkMatter', date: '02/06/2025', status: 'completed', reward: 100 },
  { name: 'LightSpeed', date: '01/06/2025', status: 'completed', reward: 50 },
  
  // Mai 2025 - 5150€ total
  { name: 'PowerUp', date: '31/05/2025', status: 'completed', reward: 50 },
  { name: 'FinalBoss', date: '30/05/2025', status: 'completed', reward: 75 },
  { name: 'PlayKing', date: '29/05/2025', status: 'completed', reward: 100 },
  { name: 'GameLord', date: '28/05/2025', status: 'completed', reward: 50 },
  { name: 'SkillMaster', date: '27/05/2025', status: 'completed', reward: 75 },
  { name: 'BestShot', date: '26/05/2025', status: 'completed', reward: 100 },
  { name: 'TopPlayer', date: '25/05/2025', status: 'completed', reward: 50 },
  { name: 'WinnerKing', date: '24/05/2025', status: 'completed', reward: 75 },
  { name: 'VictoryLord', date: '23/05/2025', status: 'completed', reward: 100 },
  { name: 'ChampionX', date: '22/05/2025', status: 'completed', reward: 50 },
  { name: 'LegendKiller', date: '21/05/2025', status: 'completed', reward: 75 },
  { name: 'MasterChief', date: '20/05/2025', status: 'completed', reward: 100 },
  { name: 'ProGamer', date: '19/05/2025', status: 'completed', reward: 50 },
  { name: 'EliteForce', date: '18/05/2025', status: 'completed', reward: 75 },
  { name: 'MaxPower', date: '17/05/2025', status: 'completed', reward: 100 },
  { name: 'TurboShark', date: '16/05/2025', status: 'completed', reward: 50 },
  { name: 'HyperBeast', date: '15/05/2025', status: 'completed', reward: 75 },
  { name: 'SuperNova', date: '14/05/2025', status: 'completed', reward: 100 },
  { name: 'MegaFalcon', date: '13/05/2025', status: 'completed', reward: 50 },
  { name: 'UltraViper', date: '12/05/2025', status: 'completed', reward: 75 },
  { name: 'PrimeHunter', date: '11/05/2025', status: 'completed', reward: 100 },
  { name: 'ZenMaster', date: '10/05/2025', status: 'completed', reward: 50 },
