...
// Données statiques persistantes pour les parrainages - ajustées pour 2000€/semaine
const STATIC_REFERRALS: StaticReferral[] = [
  ...
  { name: 'Karine B.', date: '17/04/2025', status: 'completed', reward: 300 },
  { name: 'Charles N.', date: '18/04/2025', status: 'completed', reward: 175 },
  { name: 'Lina F.', date: '19/04/2025', status: 'completed', reward: 225 },
  { name: 'Emma D.', date: '20/04/2025', status: 'completed', reward: 300 },
  { name: 'Thomas R.', date: '21/04/2025', status: 'completed', reward: 125 },
  { name: 'Sophie L.', date: '22/04/2025', status: 'completed', reward: 275 },
  { name: 'Maxime T.', date: '23/04/2025', status: 'completed', reward: 200 },
  { name: 'Julie M.', date: '24/04/2025', status: 'completed', reward: 350 },
  { name: 'Antoine B.', date: '25/04/2025', status: 'completed', reward: 150 },
  { name: 'Camille F.', date: '26/04/2025', status: 'completed', reward: 400 },
  { name: 'Nicolas P.', date: '27/04/2025', status: 'completed', reward: 175 },
  { name: 'Laura K.', date: '28/04/2025', status: 'completed', reward: 225 },
  { name: 'Hugo S.', date: '29/04/2025', status: 'completed', reward: 300 },
  { name: 'Anaïs W.', date: '30/04/2025', status: 'completed', reward: 200 },
  { name: 'Julien C.', date: '01/05/2025', status: 'completed', reward: 375 },
  { name: 'Marie H.', date: '02/05/2025', status: 'completed', reward: 125 },
  { name: 'Paul G.', date: '03/05/2025', status: 'completed', reward: 250 },
  { name: 'Claire N.', date: '04/05/2025', status: 'completed', reward: 300 },
  { name: 'Lucas J.', date: '05/05/2025', status: 'completed', reward: 275 },
  { name: 'Océane V.', date: '06/05/2025', status: 'completed', reward: 200 },
  { name: 'Romain L.', date: '07/05/2025', status: 'completed', reward: 350 },
  { name: 'Léa M.', date: '08/05/2025', status: 'completed', reward: 175 },
  { name: 'Kevin R.', date: '09/05/2025', status: 'completed', reward: 225 },
  { name: 'Manon D.', date: '10/05/2025', status: 'completed', reward: 300 },
  { name: 'Florian B.', date: '11/05/2025', status: 'completed', reward: 400 },
  { name: 'Chloé T.', date: '12/05/2025', status: 'completed', reward: 150 },
  { name: 'Alexandre S.', date: '13/05/2025', status: 'completed', reward: 250 },
  { name: 'Inès F.', date: '14/05/2025', status: 'completed', reward: 275 },
  { name: 'Bastien K.', date: '15/05/2025', status: 'completed', reward: 200 },
  { name: 'Margaux H.', date: '16/05/2025', status: 'completed', reward: 450 },
  { name: 'Quentin P.', date: '17/05/2025', status: 'completed', reward: 175 },
  { name: 'Elise C.', date: '18/05/2025', status: 'completed', reward: 325 },
  { name: 'Mathieu W.', date: '19/05/2025', status: 'completed', reward: 225 },
  { name: 'Amélie N.', date: '20/05/2025', status: 'completed', reward: 300 },
  { name: 'Valentin G.', date: '21/05/2025', status: 'completed', reward: 250 },
  { name: 'Justine L.', date: '22/05/2025', status: 'completed', reward: 375 },
  { name: 'Corentin M.', date: '23/05/2025', status: 'completed', reward: 200 },
  { name: 'Alicia R.', date: '24/05/2025', status: 'completed', reward: 275 },
  { name: 'Morgan D.', date: '25/05/2025', status: 'pending', reward: 225 },
  { name: 'Noémie B.', date: '26/05/2025', status: 'pending', reward: 400 },
