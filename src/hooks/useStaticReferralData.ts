...
const STATIC_REFERRALS: StaticReferral[] = [
  // Juin 2025 - 12200€ total (montants augmentés)
  { name: 'SkyllaGaming', date: '30/06/2025', status: 'completed', reward: 500 },
  { name: 'MoonPhoenix', date: '30/06/2025', status: 'completed', reward: 450 },
  { name: 'CyberWolfX', date: '29/06/2025', status: 'completed', reward: 400 },
  { name: 'NeonDreamer', date: '29/06/2025', status: 'pending', reward: 350 },
  { name: 'PixelHunter', date: '28/06/2025', status: 'completed', reward: 400 },
  { name: 'StardustRider', date: '28/06/2025', status: 'completed', reward: 300 },
  { name: 'VoidSeeker', date: '27/06/2025', status: 'pending', reward: 300 },
  { name: 'ThunderStrike', date: '27/06/2025', status: 'completed', reward: 450 },
  { name: 'CrimsonLord', date: '26/06/2025', status: 'completed', reward: 300 },
  { name: 'BlazeFury', date: '26/06/2025', status: 'completed', reward: 400 },
  { name: 'IceCold', date: '25/06/2025', status: 'completed', reward: 500 },
  { name: 'FireStorm', date: '25/06/2025', status: 'completed', reward: 350 },
  { name: 'WindSlash', date: '24/06/2025', status: 'completed', reward: 300 },
  { name: 'EarthShaker2', date: '24/06/2025', status: 'completed', reward: 400 },
  { name: 'UniverseKing', date: '22/06/2025', status: 'completed', reward: 500 },
  { name: 'GalacticLord', date: '23/06/2025', status: 'completed', reward: 350 },
  { name: 'PlanetHunter', date: '21/06/2025', status: 'completed', reward: 300 },
  { name: 'StarCrusher', date: '20/06/2025', status: 'completed', reward: 400 },
  { name: 'InterGalaxy', date: '19/06/2025', status: 'completed', reward: 500 },
  { name: 'AstralDragon', date: '18/06/2025', status: 'completed', reward: 350 },
  { name: 'StellarHawk', date: '17/06/2025', status: 'completed', reward: 300 },
  { name: 'LunarWolf', date: '16/06/2025', status: 'completed', reward: 400 },
  { name: 'SolarKnight', date: '15/06/2025', status: 'completed', reward: 500 },
  { name: 'CosmicWarrior', date: '14/06/2025', status: 'completed', reward: 350 },
  { name: 'NebulaFighter', date: '13/06/2025', status: 'completed', reward: 300 },
  { name: 'GalaxyGuard', date: '12/06/2025', status: 'completed', reward: 400 },
  { name: 'StarWarrior', date: '11/06/2025', status: 'completed', reward: 500 },
  { name: 'SpaceRider', date: '10/06/2025', status: 'completed', reward: 350 },
  { name: 'TimeKeeper', date: '09/06/2025', status: 'completed', reward: 300 },
  { name: 'VoidWalker', date: '08/06/2025', status: 'completed', reward: 400 },
  { name: 'LightBearer2', date: '07/06/2025', status: 'completed', reward: 500 },
  { name: 'ShadowBane', date: '06/06/2025', status: 'completed', reward: 350 },
  { name: 'FrostGuard', date: '05/06/2025', status: 'completed', reward: 300 },
  { name: 'FlameWarden', date: '04/06/2025', status: 'completed', reward: 400 },
  { name: 'StormBreaker', date: '03/06/2025', status: 'completed', reward: 500 },
  { name: 'DarkMatter', date: '02/06/2025', status: 'completed', reward: 350 },
  { name: 'LightSpeed', date: '01/06/2025', status: 'completed', reward: 300 },
  
  // Mai 2025 - 11500€ total (montants augmentés)
  { name: 'PowerUp', date: '31/05/2025', status: 'completed', reward: 400 },
  { name: 'FinalBoss', date: '30/05/2025', status: 'completed', reward: 500 },
  { name: 'PlayKing', date: '29/05/2025', status: 'completed', reward: 600 },
  { name: 'GameLord', date: '28/05/2025', status: 'completed', reward: 450 },
  { name: 'SkillMaster', date: '27/05/2025', status: 'completed', reward: 500 },
  { name: 'BestShot', date: '26/05/2025', status: 'completed', reward: 550 },
  { name: 'TopPlayer', date: '25/05/2025', status: 'completed', reward: 350 },
  { name: 'WinnerKing', date: '24/05/2025', status: 'completed', reward: 450 },
  { name: 'VictoryLord', date: '23/05/2025', status: 'completed', reward: 550 },
  { name: 'ChampionX', date: '22/05/2025', status: 'completed', reward: 400 },
  { name: 'LegendKiller', date: '21/05/2025', status: 'completed', reward: 450 },
  { name: 'MasterChief', date: '20/05/2025', status: 'completed', reward: 500 },
  { name: 'ProGamer', date: '19/05/2025', status: 'completed', reward: 350 },
  { name: 'EliteForce', date: '18/05/2025', status: 'completed', reward: 450 },
  { name: 'MaxPower', date: '17/05/2025', status: 'completed', reward: 500 },
  { name: 'TurboShark', date: '16/05/2025', status: 'completed', reward: 400 },
  { name: 'HyperBeast', date: '15/05/2025', status: 'completed', reward: 450 },
  { name: 'SuperNova', date: '14/05/2025', status: 'completed', reward: 500 },
  { name: 'MegaFalcon', date: '13/05/2025', status: 'completed', reward: 350 },
  { name: 'UltraViper', date: '12/05/2025', status: 'completed', reward: 450 },
  { name: 'PrimeHunter', date: '11/05/2025', status: 'completed', reward: 500 },
  { name: 'ZenMaster', date: '10/05/2025', status: 'completed', reward: 400 },
  { name: 'FlashLight', date: '09/05/2025', status: 'completed', reward: 300 },
  { name: 'SpeedRun', date: '08/05/2025', status: 'completed', reward: 350 },
  { name: 'QuickShot', date: '07/05/2025', status: 'completed', reward: 250 },
  { name: 'FastTrack', date: '06/05/2025', status: 'completed', reward: 300 },
  { name: 'RapidFire', date: '05/05/2025', status: 'completed', reward: 350 },
  { name: 'SwiftArrow', date: '04/05/2025', status: 'completed', reward: 250 },
  { name: 'BlitzKrieg', date: '03/05/2025', status: 'completed', reward: 300 },
  { name: 'RushHour', date: '02/05/2025', status: 'completed', reward: 350 },
  { name: 'DashBoard', date: '01/05/2025', status: 'completed', reward: 250 },
  
  // Avril 2025 - 11850€ total (montants augmentés)
  { name: 'PhiRaven', date: '30/04/2025', status: 'completed', reward: 400 },
  { name: 'TauPanther', date: '29/04/2025', status: 'completed', reward: 450 },
  { name: 'RhoCobra', date: '28/04/2025', status: 'completed', reward: 500 },
  { name: 'XiShark', date: '27/04/2025', status: 'completed', reward: 400 },
  { name: 'NuFalcon', date: '26/04/2025', status: 'completed', reward: 450 },
  { name: 'MuDragon', date: '25/04/2025', status: 'completed', reward: 500 },
  { name: 'LambdaViper', date: '24/04/2025', status: 'completed', reward: 400 },
  { name: 'KappaEagle', date: '23/04/2025', status: 'completed', reward: 450 },
  { name: 'SigmaHawk', date: '22/04/2025', status: 'completed', reward: 500 },
  { name: 'OmegaTiger', date: '21/04/2025', status: 'completed', reward: 400 },
  { name: 'ThetaLion', date: '20/04/2025', status: 'completed', reward: 450 },
  { name: 'ZetaPhoenix', date: '19/04/2025', status: 'completed', reward: 500 },
  { name: 'EpsilonBlade', date: '18/04/2025', status: 'completed', reward: 400 },
  { name: 'DeltaStrike', date: '17/04/2025', status: 'completed', reward: 450 },
  { name: 'GammaForce', date: '16/04/2025', status: 'completed', reward: 500 },
  { name: 'BetaRanger', date: '15/04/2025', status: 'completed', reward: 400 },
  { name: 'AlphaWolf', date: '14/04/2025', status: 'completed', reward: 450 },
  { name: 'OmegaEnd', date: '13/04/2025', status: 'completed', reward: 500 },
  { name: 'AlphaStart', date: '12/04/2025', status: 'completed', reward: 400 },
  { name: 'BetaTest', date: '11/04/2025', status: 'completed', reward: 450 },
  { name: 'GammaBurst', date: '10/04/2025', status: 'completed', reward: 500 },
  { name: 'DeltaWave', date: '09/04/2025', status: 'completed', reward: 400 },
  { name: 'EpsilonCore', date: '08/04/2025', status: 'completed', reward: 450 },
  { name: 'ZetaField', date: '07/04/2025', status: 'completed', reward: 500 },
  { name: 'ThetaRay', date: '06/04/2025', status: 'completed', reward: 400 },
  { name: 'IotaBeam', date: '05/04/2025', status: 'completed', reward: 450 },
  { name: 'KappaFlux', date: '04/04/2025', status: 'completed', reward: 500 },
  { name: 'LambdaCrux', date: '03/04/2025', status: 'completed', reward: 400 },
  { name: 'MuPulse', date: '02/04/2025', status: 'completed', reward: 450 },
  { name: 'NuWave', date: '01/04/2025', status: 'completed', reward: 500 },
