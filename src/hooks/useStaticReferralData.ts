...
const STATIC_REFERRALS: StaticReferral[] = [
  // Juillet 2025 - 10000€ total (ajusté pour atteindre 35 550€ au total)
  { name: 'SkyllaGaming', date: '30/07/2025', status: 'completed', reward: 450 },
  { name: 'MoonPhoenix', date: '30/07/2025', status: 'completed', reward: 400 },
  { name: 'CyberWolfX', date: '29/07/2025', status: 'completed', reward: 450 },
  { name: 'NeonDreamer', date: '29/07/2025', status: 'pending', reward: 350 },
  { name: 'PixelHunter', date: '28/07/2025', status: 'completed', reward: 400 },
  { name: 'StardustRider', date: '28/07/2025', status: 'completed', reward: 300 },
  { name: 'VoidSeeker', date: '27/07/2025', status: 'pending', reward: 350 },
  { name: 'ThunderStrike', date: '27/07/2025', status: 'completed', reward: 450 },
  { name: 'CrimsonLord', date: '26/07/2025', status: 'completed', reward: 300 },
  { name: 'BlazeFury', date: '26/07/2025', status: 'completed', reward: 400 },
  { name: 'IceCold', date: '25/07/2025', status: 'completed', reward: 450 },
  { name: 'FireStorm', date: '25/07/2025', status: 'completed', reward: 350 },
  { name: 'WindSlash', date: '24/07/2025', status: 'completed', reward: 300 },
  { name: 'EarthShaker2', date: '24/07/2025', status: 'completed', reward: 400 },
  { name: 'UniverseKing', date: '22/07/2025', status: 'completed', reward: 450 },
  { name: 'GalacticLord', date: '23/07/2025', status: 'completed', reward: 350 },
  { name: 'PlanetHunter', date: '21/07/2025', status: 'completed', reward: 300 },
  { name: 'StarCrusher', date: '20/07/2025', status: 'completed', reward: 400 },
  { name: 'InterGalaxy', date: '19/07/2025', status: 'completed', reward: 450 },
  { name: 'AstralDragon', date: '18/07/2025', status: 'completed', reward: 350 },
  { name: 'StellarHawk', date: '17/07/2025', status: 'completed', reward: 300 },
  { name: 'LunarWolf', date: '16/07/2025', status: 'completed', reward: 400 },
  { name: 'SolarKnight', date: '15/07/2025', status: 'completed', reward: 450 },
  { name: 'CosmicWarrior', date: '14/07/2025', status: 'completed', reward: 350 },
  { name: 'NebulaFighter', date: '13/07/2025', status: 'completed', reward: 300 },
  { name: 'GalaxyGuard', date: '12/07/2025', status: 'completed', reward: 400 },
  { name: 'StarWarrior', date: '11/07/2025', status: 'completed', reward: 450 },
  { name: 'SpaceRider', date: '10/07/2025', status: 'completed', reward: 350 },
  { name: 'TimeKeeper', date: '09/07/2025', status: 'completed', reward: 300 },
  { name: 'VoidWalker', date: '08/07/2025', status: 'completed', reward: 400 },
  { name: 'LightBearer2', date: '07/07/2025', status: 'completed', reward: 450 },
  { name: 'ShadowBane', date: '06/07/2025', status: 'completed', reward: 350 },
  { name: 'FrostGuard', date: '05/07/2025', status: 'completed', reward: 300 },
  { name: 'FlameWarden', date: '04/07/2025', status: 'completed', reward: 400 },
  { name: 'StormBreaker', date: '03/07/2025', status: 'completed', reward: 450 },
  { name: 'DarkMatter', date: '02/07/2025', status: 'completed', reward: 350 },
  { name: 'LightSpeed', date: '01/07/2025', status: 'completed', reward: 300 },
