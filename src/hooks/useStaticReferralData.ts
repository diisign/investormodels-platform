...
const STATIC_REFERRALS: StaticReferral[] = [
  ...
  { name: 'StardustRider', date: '28/06/2025', status: 'completed', reward: 120 },
  { name: 'VoidSeeker', date: '27/06/2025', status: 'pending', reward: 120 },
  { name: 'ThunderStrike', date: '27/06/2025', status: 'completed', reward: 200 },
  { name: 'CrimsonLord', date: '26/06/2025', status: 'completed', reward: 120 },
  { name: 'BlazeFury', date: '26/06/2025', status: 'completed', reward: 180 },
  { name: 'IceCold', date: '25/06/2025', status: 'completed', reward: 250 },
  { name: 'FireStorm', date: '25/06/2025', status: 'completed', reward: 180 },
  { name: 'WindSlash', date: '24/06/2025', status: 'completed', reward: 120 },
  { name: 'EarthShaker2', date: '24/06/2025', status: 'completed', reward: 180 },
  { name: 'UniverseKing', date: '22/06/2025', status: 'completed', reward: 250 },
  { name: 'GalacticLord', date: '23/06/2025', status: 'completed', reward: 180 },
  { name: 'PlanetHunter', date: '21/06/2025', status: 'completed', reward: 120 },
  { name: 'StarCrusher', date: '20/06/2025', status: 'completed', reward: 180 },
  { name: 'InterGalaxy', date: '19/06/2025', status: 'completed', reward: 250 },
  { name: 'AstralDragon', date: '18/06/2025', status: 'completed', reward: 180 },
  { name: 'StellarHawk', date: '17/06/2025', status: 'completed', reward: 120 },
  { name: 'LunarWolf', date: '16/06/2025', status: 'completed', reward: 180 },
  { name: 'SolarKnight', date: '15/06/2025', status: 'completed', reward: 250 },
  { name: 'CosmicWarrior', date: '14/06/2025', status: 'completed', reward: 180 },
  { name: 'NebulaFighter', date: '13/06/2025', status: 'completed', reward: 120 },
  { name: 'GalaxyGuard', date: '12/06/2025', status: 'completed', reward: 180 },
  { name: 'StarWarrior', date: '11/06/2025', status: 'completed', reward: 250 },
  { name: 'SpaceRider', date: '10/06/2025', status: 'completed', reward: 180 },
  { name: 'TimeKeeper', date: '09/06/2025', status: 'completed', reward: 120 },
  { name: 'VoidWalker', date: '08/06/2025', status: 'completed', reward: 180 },
  { name: 'LightBearer2', date: '07/06/2025', status: 'completed', reward: 250 },
  { name: 'ShadowBane', date: '06/06/2025', status: 'completed', reward: 180 },
  { name: 'FrostGuard', date: '05/06/2025', status: 'completed', reward: 120 },
  { name: 'FlameWarden', date: '04/06/2025', status: 'completed', reward: 180 },
  { name: 'StormBreaker', date: '03/06/2025', status: 'completed', reward: 250 },
  { name: 'DarkMatter', date: '02/06/2025', status: 'completed', reward: 180 },
  { name: 'LightSpeed', date: '01/06/2025', status: 'completed', reward: 120 },
  
  // Mai 2025 - 7000€ total
  { name: 'PowerUp', date: '31/05/2025', status: 'completed', reward: 230 },
  { name: 'FinalBoss', date: '30/05/2025', status: 'completed', reward: 280 },
  { name: 'PlayKing', date: '29/05/2025', status: 'completed', reward: 320 },
  { name: 'GameLord', date: '28/05/2025', status: 'completed', reward: 250 },
  { name: 'SkillMaster', date: '27/05/2025', status: 'completed', reward: 280 },
  { name: 'BestShot', date: '26/05/2025', status: 'completed', reward: 300 },
  { name: 'TopPlayer', date: '25/05/2025', status: 'completed', reward: 180 },
  { name: 'WinnerKing', date: '24/05/2025', status: 'completed', reward: 250 },
  { name: 'VictoryLord', date: '23/05/2025', status: 'completed', reward: 300 },
  { name: 'ChampionX', date: '22/05/2025', status: 'completed', reward: 230 },
  { name: 'LegendKiller', date: '21/05/2025', status: 'completed', reward: 250 },
  { name: 'MasterChief', date: '20/05/2025', status: 'completed', reward: 280 },
  { name: 'ProGamer', date: '19/05/2025', status: 'completed', reward: 180 },
  { name: 'EliteForce', date: '18/05/2025', status: 'completed', reward: 250 },
  { name: 'MaxPower', date: '17/05/2025', status: 'completed', reward: 280 },
  { name: 'TurboShark', date: '16/05/2025', status: 'completed', reward: 230 },
  { name: 'HyperBeast', date: '15/05/2025', status: 'completed', reward: 250 },
  { name: 'SuperNova', date: '14/05/2025', status: 'completed', reward: 280 },
  { name: 'MegaFalcon', date: '13/05/2025', status: 'completed', reward: 180 },
  { name: 'UltraViper', date: '12/05/2025', status: 'completed', reward: 250 },
  { name: 'PrimeHunter', date: '11/05/2025', status: 'completed', reward: 280 },
  { name: 'ZenMaster', date: '10/05/2025', status: 'completed', reward: 230 },
  { name: 'FlashLight', date: '09/05/2025', status: 'completed', reward: 160 },
  { name: 'SpeedRun', date: '08/05/2025', status: 'completed', reward: 180 },
  { name: 'QuickShot', date: '07/05/2025', status: 'completed', reward: 130 },
  { name: 'FastTrack', date: '06/05/2025', status: 'completed', reward: 160 },
  { name: 'RapidFire', date: '05/05/2025', status: 'completed', reward: 180 },
  { name: 'SwiftArrow', date: '04/05/2025', status: 'completed', reward: 130 },
  { name: 'BlitzKrieg', date: '03/05/2025', status: 'completed', reward: 160 },
  { name: 'RushHour', date: '02/05/2025', status: 'completed', reward: 180 },
  { name: 'DashBoard', date: '01/05/2025', status: 'completed', reward: 130 },
  
  // Avril 2025 - 7000€ total
  { name: 'PhiRaven', date: '30/04/2025', status: 'completed', reward: 230 },
  { name: 'TauPanther', date: '29/04/2025', status: 'completed', reward: 250 },
  { name: 'RhoCobra', date: '28/04/2025', status: 'completed', reward: 280 },
  { name: 'XiShark', date: '27/04/2025', status: 'completed', reward: 230 },
  { name: 'NuFalcon', date: '26/04/2025', status: 'completed', reward: 250 },
  { name: 'MuDragon', date: '25/04/2025', status: 'completed', reward: 280 },
  { name: 'LambdaViper', date: '24/04/2025', status: 'completed', reward: 230 },
  { name: 'KappaEagle', date: '23/04/2025', status: 'completed', reward: 250 },
  { name: 'SigmaHawk', date: '22/04/2025', status: 'completed', reward: 280 },
  { name: 'OmegaTiger', date: '21/04/2025', status: 'completed', reward: 230 },
  { name: 'ThetaLion', date: '20/04/2025', status: 'completed', reward: 250 },
  { name: 'ZetaPhoenix', date: '19/04/2025', status: 'completed', reward: 280 },
  { name: 'EpsilonBlade', date: '18/04/2025', status: 'completed', reward: 230 },
  { name: 'DeltaStrike', date: '17/04/2025', status: 'completed', reward: 250 },
  { name: 'GammaForce', date: '16/04/2025', status: 'completed', reward: 280 },
  { name: 'BetaRanger', date: '15/04/2025', status: 'completed', reward: 230 },
  { name: 'AlphaWolf', date: '14/04/2025', status: 'completed', reward: 250 },
  { name: 'OmegaEnd', date: '13/04/2025', status: 'completed', reward: 280 },
  { name: 'AlphaStart', date: '12/04/2025', status: 'completed', reward: 230 },
  { name: 'BetaTest', date: '11/04/2025', status: 'completed', reward: 250 },
  { name: 'GammaBurst', date: '10/04/2025', status: 'completed', reward: 280 },
  { name: 'DeltaWave', date: '09/04/2025', status: 'completed', reward: 230 },
  { name: 'EpsilonCore', date: '08/04/2025', status: 'completed', reward: 250 },
  { name: 'ZetaField', date: '07/04/2025', status: 'completed', reward: 280 },
  { name: 'ThetaRay', date: '06/04/2025', status: 'completed', reward: 230 },
  { name: 'IotaBeam', date: '05/04/2025', status: 'completed', reward: 250 },
  { name: 'KappaFlux', date: '04/04/2025', status: 'completed', reward: 280 },
  { name: 'LambdaCrux', date: '03/04/2025', status: 'completed', reward: 230 },
  { name: 'MuPulse', date: '02/04/2025', status: 'completed', reward: 250 },
  { name: 'NuWave', date: '01/04/2025', status: 'completed', reward: 280 },
