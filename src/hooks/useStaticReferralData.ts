...
const STATIC_REFERRALS: StaticReferral[] = [
  ...
  { name: 'CyberWolfX', date: '29/06/2025', status: 'completed', reward: 300 },
  ...
  { name: 'VoidSeeker', date: '27/06/2025', status: 'pending', reward: 200 },
  { name: 'ThunderStrike', date: '27/06/2025', status: 'completed', reward: 300 },
  { name: 'CrimsonLord', date: '26/06/2025', status: 'completed', reward: 150 },
  { name: 'BlazeFury', date: '26/06/2025', status: 'completed', reward: 250 },
  ...
  { name: 'StarCrusher', date: '20/06/2025', status: 'completed', reward: 250 },
  ...
  { name: 'GalaxyGuard', date: '12/06/2025', status: 'completed', reward: 250 },
  ...
  { name: 'VoidWalker', date: '08/06/2025', status: 'completed', reward: 250 },
