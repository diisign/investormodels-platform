        ...
        <AreaChart data={chartData} margin={{
          ...
          bottom: 5
            ...
            return null;
              ...
              <Area type="monotone" dataKey="invested" stroke="#0ea5e9" fillOpacity={1} fill="url(#investedGradient)" name="Investissement" stackId="1" />
              <Area type="monotone" dataKey="return" stroke="#22c55e" fillOpacity={1} fill="url(#returnGradient)" name="Rendement" />
