...
const GradientButton: React.FC<GradientButtonProps> = ({
  ...
  const getVariantClasses = () => {
    switch (variant) {
      case 'primary':
        return `bg-gradient-${gradientDirection} from-investment-600 to-investment-500 text-white hover:shadow-lg hover:shadow-investment-500/20 focus:ring-investment-500/50`;
      case 'secondary':
