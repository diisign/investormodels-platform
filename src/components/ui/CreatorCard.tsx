...
const CreatorCard = ({ 
  ...
  return (
    <motion.div 
      ...
      className={`bg-card dark:bg-card/90 backdrop-blur-sm rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 ${className} relative border border-border/50`}
    >
      {rank !== undefined && (
      ...
      <Link to={`/creator/${id}`} className="block h-full">
        <div className="relative p-2 sm:p-4">
          ...
          <div className="bg-primary/10 dark:bg-primary/5 rounded-lg p-2 sm:p-3 mb-2 sm:mb-3 border border-primary/20">
