      ...
      <div onClick={handleClick} className="block h-full cursor-pointer flex flex-col">
        <div className="relative p-2 bg-slate-100 flex-1 flex flex-col justify-between">
          ...
          <div className="flex-1 flex flex-col items-center justify-center space-y-4">
            ...
            return <div className={`flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium mt-3 ${isPositive ? 'text-green-500' : 'bg-red-200/50 text-red-500'}`} style={{backgroundColor: isPositive ? '#e7f9f1' : undefined}}>
