          ...
          <div className="container mx-auto px-4">
            <FadeIn direction="up" delay={200}>
              <div className="flex flex-wrap justify-center gap-8">
                ...
                <div className="flex items-center">
                  <img src="/lovable-uploads/524b83a2-faac-4024-b292-0aacd341b37c.png" alt="Followers" className="h-5 w-5 mr-2" style={{filter: 'brightness(0) saturate(100%) invert(42%) sepia(93%) saturate(1352%) hue-rotate(87deg) brightness(119%) contrast(119%)'}} />
