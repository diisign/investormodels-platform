...
const Index = () => {
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-16 md:pt-20">
            ...
            <div className="max-w-3xl mx-auto text-center">
              <FadeIn className="space-y-4 md:space-y-6" direction="up">
                <div className="inline-block rounded-full px-3 py-1 text-sm font-medium text-purple-600 dark:text-purple-400 mb-3 md:mb-4 bg-slate-950">
                  <span className="text-yellow-300 text-sm">Nouvelle façon d'investir</span>
                </div>
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight xl:text-3xl">
                  Investissez dans les <span className="text-yellow-300 text-4xl">créatrices OnlyFans.</span>
                </h1>
                
                
                <div className="pt-2 rounded-full bg-transparent">
                ...
                <div className="flex flex-wrap items-center justify-center gap-6 md:gap-8 pt-4 md:pt-6">
                  <div className="flex flex-col items-center">
                    <span className="text-2xl md:text-3xl font-bold text-slate-950">250+</span>
                    <span className="text-sm text-gray-600">Créatrices</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <span className="text-2xl md:text-3xl font-bold text-slate-950">20K+</span>
                    <span className="text-sm text-gray-500">Investisseurs</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <span className="text-2xl md:text-3xl font-bold text-slate-950">7M €</span>
        ...
        <section ref={creatorsRef} className="py-12 md:py-20 rounded-full">
          <div className="container mx-auto px-4">
            <FadeIn className="flex flex-col md:flex-row md:justify-between md:items-end mb-8 md:mb-12" direction="up">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4 text-yellow-300 mx-[3px] px-0 py-0 my-0 lg:text-4xl">
                  Top créatrices
                </h2>
