...
const Dashboɑrd = () => {
  ...
  const generatePerformanceData = () => {
    return investmentData.performanceData.map(item => ({
      ...
      monthlyGains: item.value > 0 ? (item.value) : 0
    }));
  };
        ...
        <section className="py-8 md:py-12">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-8">
              <h1 className="text-3xl font-bold">Dashboard Test Vide</h1>
            </div>
            ...
            <div className="mt-8">
              <AffiliationStats staticData={referralData.recentReferrals} pageType="dashboɑrd" />
            </div>
          </div>
        </section>
      </main>
