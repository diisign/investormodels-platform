    ...
    for (let i = 0; i < 13; i++) {
      ...
      investments.forEach(inv => {
        ...
        if (investmentMonth <= monthDate) {
          ...
          const monthsSinceInvestment = (monthDate.getFullYear() - investmentDate.getFullYear()) * 12 + (monthDate.getMonth() - investmentDate.getMonth());
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <select className="text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2" value={timeRange} onChange={e => setTimeRange(e.target.value)}>
                      <option value="12">{t('dashboard.months12')}</option>
                      <option value="6">{t('dashboard.months6')}</option>
                      <option value="3">{t('dashboard.months3')}</option>
                    </select>
                  </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="number" id="amount" value={depositAmount} onChange={e => setDepositAmount(e.target.value)} min="10" step="10" className="block w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-investment-500 dark:focus:ring-investment-400 focus:border-transparent dark:bg-gray-700" placeholder="100" required />
                  </div>
                </div>
